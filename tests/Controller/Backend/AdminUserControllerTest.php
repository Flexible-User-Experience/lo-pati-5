...
class AdminUserControllerTest extends WebTestCase
{
    ...
    public function provideUrls(): array
    {
        return [
            ...
            ['/admin/app/slideshow/list'],
            ['/admin/app/slideshow/create'],
            ['/admin/app/slideshow/1/edit'],
            ['/admin/app/slideshow/1/delete'],
            ['/admin/app/page/list'],
    ...
    public function provideNotFoundUrls(): array
    {
        return [
            ...
            ['/admin/app/slideshow/9/edit'],
            ['/admin/app/slideshow/1/show'],
            ['/admin/app/slideshow/1/delete'],
