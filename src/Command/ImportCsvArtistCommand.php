...
final class ImportCsvArtistCommand extends AbstractBaseCommand
{
    protected function configure(): void
    {
        ...
        $this->setDescription('Import an artist CSV file');
        parent::configure();
    }
        ...
        while (false !== ($data = $this->readRow($fr))) {
            if (count($data) >= 17) {
                ...
                $artist
                    ...
                    ->setDescription(AbstractBaseCommand::sanitizeNewLineEscapeChar(AbstractBaseCommand::sanitizeDoubleQuoteEscapeChar($this->readColumn(6, $data))))
                    ...
                    ->setWebpage(AbstractBaseCommand::sanitizeLinksWithoutProtocol($this->readColumn(15, $data)))
